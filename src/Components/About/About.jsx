  ...
  return (
    <div id="about">
      <div id="about-stuff" className={matches ? "about-column" : "about-row"}>
        ...
        <p id="about-content">
          I enjoy cooking, video games, and the wilderness. When I am not
          learning about or writing code, you can find me with friends and
          family, my pups, or dusting clay pigeons at The Shooting Park.
        </p>
